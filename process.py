...
if not os.path.isfile(template):
    ...
    exit(1)
client = boto3.client('cloudformation', region_name=config['region'], aws_access_key_id=os.environ['AWS_ACCESS_KEY_ID'], aws_secret_access_key=os.environ['AWS_SECRET_ACCESS_KEY'])
args = config['options']
